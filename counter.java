...
Scanner currency=new Scanner(System.in);
		...
		case 1:
			...
			System.out.println("amount in yen"+(a*1.79)+ "¥");
		...
		System.out.println("amount in rupees"+(c*280)+"Rs");
		...
		case 4:
			...
			System.out.println("amount in yen"+(d*1.79));
		...
		case 5:
			...
			System.out.println("amount in pkr"+(e/74.34) + "Rs");
